...
## Latest Release (as of 2025)
- v0.8.0 (June 2025): MCP protocol support, expanded indexing types, knowledge base decoupling from applications
- v0.7 (April 2025): Refactored solver, static/iterative planning modes, "lightweight build" mode (89% token cost reduction)
